module.exports.formulario_inclusao_noticia = (application, req, res)=> res.render("admin/form_add_noticia",{validacao:{}, noticia:{}});
...
module.exports.noticiaSalvar = (application, req, res)=>{
    ...
    noticiasModel.salvarNoticia(noticia,connection,(erro,result)=> res.redirect('/noticias'));
